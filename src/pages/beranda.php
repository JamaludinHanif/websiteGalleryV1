...
<div class="bg-white">
  ...
  <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
    <p class="font-bold text-xl mt-5">Beranda</p>
    ...
    ?>
        ...
        <div class="mt-6 flex justify-between">
            ...
            ?>
                <a href="../config/like.php?fotoid=<?= $data['FotoId'] ?>" name="like" class="relative w-1/4 flex items-center justify-center rounded-md border border-transparent bg-gray-100 px-2 py-2 text-sm font-medium text-gray-900 hover:bg-gray-200">❤️ Like</a>
            <?php
                } else {
            ?>
                <a href="../config/like.php?fotoid=<?= $data['FotoId'] ?>" name="like" class="relative w-1/4 flex items-center justify-center rounded-md border border-transparent bg-gray-100 px-2 py-2 text-sm font-medium text-gray-900 hover:bg-gray-200">🩶 Like</a>
            <?php
                }
            ?>
        <a href="komentar.php?fotoid=<?= $data['FotoId'] ?>" class="relative w-2/4 flex items-center justify-center rounded-md border border-transparent bg-gray-100 px-2 py-2 text-sm font-medium text-gray-900 hover:bg-gray-200">💬 Komentar</a>
        </div>
      </div>
    <?php
    }
